...
f <- paste0("C:/Users/n10393021/OneDrive - Queensland University of Technology/Documents/PhD/Project/Fieldwork_Bowra/Oct2019/SummaryIndices_Channel1_Prepared/Plots")
if (!dir.exists(f)) {
  dir.create("C:/Users/n10393021/OneDrive - Queensland University of Technology/Documents/PhD/Project/Fieldwork_Bowra/Oct2019/SummaryIndices_Channel1_Prepared/Plots")
}

# load normalised summary indices
load("C:/Users/n10393021/OneDrive - Queensland University of Technology/Documents/PhD/Project/Fieldwork_Bowra/Oct2019/SummaryIndices_Channel1_Prepared/normalised_indices.RData")
...
load("C:/Users/n10393021/OneDrive - Queensland University of Technology/Documents/PhD/Project/Fieldwork_Bowra/Oct2019/SummaryIndices_Channel1_Prepared/Results/hclust_clusters_25000.RData")
...
colnames(medoids) <- c("clust", "BGN", "HFC",
                       "ACI", "EAS", "EPS",
                       "CLC", "NDSI")

distances <- as.matrix(dist(medoids[,2:8]))
...
tiff("C:/Users/n10393021/OneDrive - Queensland University of Technology/Documents/PhD/Project/Fieldwork_Bowra/Oct2019/SummaryIndices_Channel1_Prepared/Plots/Sammon plot_1.tiff", 
