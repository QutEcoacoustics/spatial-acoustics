...
total1 <- read.csv(getDataPath(chapter, "05.07.2021_motifs_birdID.csv")) %>% 
...
write.csv(data.scores, getDataPath(chapter, "nmds_sp_data.scores.csv"))
...
write.csv(species.scores, getDataPath(chapter, "nmds_sp_species.scores.csv"))
