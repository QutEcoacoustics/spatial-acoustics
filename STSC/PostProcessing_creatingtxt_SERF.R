...
write.table(motifs_evn, getDataPath("STSC", "Results", point_id, paste("result", index_abb1, "_", point_id, "_432.txt", sep = "")), row.names = F, col.names = F)
...
write.table(motifs_aci, getDataPath("STSC", "Results", point_id, paste("result", index_abb2, "_", point_id, "_432.txt", sep = "")), row.names = F, col.names = F)
...
write.table(motifs_ent, getDataPath("STSC", "Results", point_id, paste("result", index_abb3, "_", point_id, "_432.txt", sep = "")), row.names = F, col.names = F)
