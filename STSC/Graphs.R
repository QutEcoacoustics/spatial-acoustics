...
df_motif <- read.csv(getDataPath(point, index, paste(point, index, "motif.csv", sep = "_")))
df_match <- read.csv(getDataPath(point, index, paste(point, index, "match.csv", sep = "_")))
...
ggsave(getDataPath(point, index, "Figures", paste(index, "ts_motifs_matches.jpg"), sep = ""))
