...
df_2 <- read.csv("C:/Users/n10393021/OneDrive - Queensland University of Technology/Documents/PhD/Project/AIndices/11_FinalDF/2_chp3.csv")
df_28 <- read.csv("C:/Users/n10393021/OneDrive - Queensland University of Technology/Documents/PhD/Project/AIndices/11_FinalDF/28_chp3.csv")
df_64 <- read.csv("C:/Users/n10393021/OneDrive - Queensland University of Technology/Documents/PhD/Project/AIndices/11_FinalDF/64_chp3.csv")
df_65 <- read.csv("C:/Users/n10393021/OneDrive - Queensland University of Technology/Documents/PhD/Project/AIndices/11_FinalDF/65_chp3.csv")
df_77 <- read.csv("C:/Users/n10393021/OneDrive - Queensland University of Technology/Documents/PhD/Project/AIndices/11_FinalDF/77_chp3.csv")

df <- rbind(df_2, df_28, df_64, df_65, df_77)

write.csv(df, getDataPath("12.04.2022_completedf.csv"))

summary_count <- df %>% group_by(general_category, site, month) %>% 
  summarise(n())

df_filtered <- filter(df, general_category == "anthrophony/biophony" | general_category == "anthrophony/biophony/geophony" | general_category == "biophony" | general_category == "biophony/geophony") %>% 
...
df_filtered$RFclass <- as.factor(df_filtered$RFclass)
df_filtered$period <- as.factor(df_filtered$period)
df_filtered$Date <- as.Date.character(df_filtered$Date) %>% 
  sort()

df_filtered$Recording_time <- factor(df_filtered$Recording_time, levels = c("0:00:00", "2:00:00", "4:00:00", "6:00:00", "8:00:00", "10:00:00", "12:00:00", "14:00:00", "16:00:00", "18:00:00", "20:00:00", "22:00:00"))
