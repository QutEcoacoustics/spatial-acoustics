...
rda <- vegan::rda(dataframe_land_wide[,6:8] ~ period + mean_temp, data = dataframe_land_wide)
RsquareAdj(rda)
summary(rda)
...
rda <- vegan::rda(dataframe_land_wide[,6:7] ~ period + mean_temp + natural_cover_325, data = dataframe_land_wide)
RsquareAdj(rda)
summary(rda)
autoplot(rda)
...
rda <- vegan::rda(dataframe_land_wide[,8:10] ~ period + mean_temp + natural_cover_325, data = dataframe_land_wide)
RsquareAdj(rda)
summary(rda)
autoplot(rda)
