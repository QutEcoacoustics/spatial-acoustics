...
data_og <- filter(data_og, period == "night")
...
global_model <- lm(n ~ contag_landscape_325 + ca_class_2_325 + ca_class_4_325 + np_landscape_325 + ca_class_3_325 + ca_class_1_325 + ca_class_5_325 + ca_class_7_325 + ca_class_8_325 + ca_class_9_325 + ndvi_mean + ebi_max + ndwi_mean + temp_max + rain_value + moon_illu + bvg_char + month, data = data_og)
...
lm.bp <- bptest(n ~ contag_landscape_325 + ca_class_2_325 + ca_class_4_325 + np_landscape_325 + ca_class_3_325 + ca_class_1_325 + ca_class_5_325 + ca_class_7_325 + ca_class_8_325 + ca_class_9_325 + ndvi_mean + ebi_max + ndwi_mean + temp_max + rain_value + moon_illu + bvg_char + month, data = data_og, studentize = T)
...
IndVar <- c("contag_landscape_325" , "ca_class_2_325" , "ca_class_4_325" , "np_landscape_325" , "ca_class_3_325" , "ca_class_1_325" , "ca_class_5_325" , 'ca_class_7_325' , "ca_class_8_325" , "ca_class_9_325" , "ndvi_mean" , 'ebi_max' , 'ndwi_mean' , "temp_max" , 'rain_value' , "moon_illu" , "bvg_char" , "month")
...
ggplot(model, aes(x = site, y = Local_R2)) +
  ...
  ggsave(getDataPath("Figures", "02.05.2022_gwrr2valuespersite_nightmodel.tiff"))
...
ggplot(df_gather, aes(x = site, y = coefficient_value, fill = coefficient_name)) +
  ...
  ggsave(getDataPath("Figures", "02.05.2022_Coefficients_nightmodel.tiff"))
