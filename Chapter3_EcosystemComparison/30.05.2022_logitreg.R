...
cor.test(data_og$mean_temp, data_og$np_landscape_3k)
cor.test(data_og$np_landscape_3k, data_og$contag_landscape_3k)
cor.test(data_og$natural_cover_3k, data_og$natural_cover_3k)
cor.test(data_og$natural_cover_3k, data_og$water_3k)
cor.test(data_og$natural_cover_3k, data_og$tca_landscape_3k)

cor.test(data_og$np_landscape_325, data_og$ndvi_mean)
cor.test(data_og$mean_temp, data_og$rain_value)
cor.test(data_og$mean_temp, data_og$np_landscape_325)
cor.test(data_og$natural_cover_325, data_og$contag_landscape_325)
cor.test(data_og$np_landscape_325, data_og$moon_illu)
cor.test(data_og$np_landscape_325, data_og$natural_cover_325)
cor.test(data_og$tca_landscape_325, data_og$water_325)
cor.test(data_og$tca_landscape_325, data_og$tca_landscape_325)


m1 <- multinom(RFclass ~ bvg_char + mean_temp + contag_landscape_325 + moon_illu + natural_cover_325 + tca_landscape_325 + ndvi_mean + rain_value, data = train)
summary(m1)
...
#Best model ----
m2 <- multinom(RFclass ~ bvg_char + mean_temp + contag_landscape_325 + moon_illu + natural_cover_325 + tca_landscape_325
, data = train)
summary(m2)
